...
if not os.path.exists("./experiments/{}-experiment-mace{}/".format(env_name, NUM_EXPERTS)):
  os.mkdir("./experiments/{}-experiment-mace{}/".format(env_name. NUM_EXPERTS))
...
for kase in xrange(5):
  ...
  save_path = saver.save(sess, "./experiments/{}-experiment-mace{}/model{}".format(env_name, kase))
